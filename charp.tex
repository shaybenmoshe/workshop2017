...
\begin{proof}
	...
	\todo{How do we remove the $^p$? I think it follows if we don't have nilpotents..}
\end{proof}
...
\todo{Existence for each height over a field, uniqueness over an algebraically closed field.}